...
![Illustrated summary of Cellist cell identification and transcript assignment](../images/2026-06-05/01-cellist-illustrated.png)

*Imaging, local transcript density and candidate nuclei guide boundary refinement, transcript-to-cell assignment and construction of a cell-by-gene matrix.*
...
![Illustrated summary of BaySC Bayesian clustering and uncertainty](../images/2026-06-05/02-baysc-illustrated.png)

*Spatially coupled latent assignments and modality-weighted likelihoods are sampled to produce domain labels, membership probabilities and boundary uncertainty.*
...
![Illustrated summary of STORM multimodal hierarchical representation learning](../images/2026-06-05/03-storm-illustrated.png)

*Matched histology, expression and neighborhood context are encoded into local and tissue-level representations for spatial discovery, virtual expression and clinical prediction.*
